            ...
            <div class="container">
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="{{ url('/detail') }}">Créer demande</a> </li>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="register-form">
                        ...
                        <form action="{{ route('template.demande') }}" method="POST">
                            @csrf
                            <div class="group-input">
                                <label for="coord">Les coordonnées : </label>
                            ...
                            <button type="submit" class="site-btn register-btn">AJouter demande</button>
                        </form>
                    </div>
                </div>
            </div>
